...
try:
    ...
    print("Switch has been successfully configured to update its calendar with NTP.")
    ...
    print("An error occurred while configuring 'ntp update-calendar' on the switch.")
