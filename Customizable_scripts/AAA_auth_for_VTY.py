...
try:
    ...
    # AAA Configuration Commands for VTY Access
    commands = [
        'aaa new-model',
        'aaa authentication login VTY_AUTH local',
        f'username {aaa_username} privilege 15 secret {aaa_password}',
        'line vty 0 4',
    ...
    if "Invalid input detected" in output or "Incomplete command" in output:
        raise Exception("An error occurred while configuring AAA for VTY access. Please check the commands and try again.")

    # Print success message
    print("AAA configuration for VTY access completed successfully!")
