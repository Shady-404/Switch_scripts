...
# Prompt user for interface and bandwidth
interface = get_user_input("Enter the interface(s) (e.g., Ethernet0/0, e0/0, or a range like e0/0-3): ")
bandwidth = get_user_input("Enter the bandwidth in kbps: ")
...
try:
    ...
    # Commands to specify the bandwidth for the interface
    commands = [
    ...
    print(f"Bandwidth for {interface} set to {bandwidth} kbps successfully.")
