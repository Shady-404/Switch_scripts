...
try:
    ...
    # Command to save the running configuration to FTP server
    command = f"copy running-config ftp://{ftp_username}:{ftp_password}@{ftp_server}/{file_name}"
    ...
    print(f"Configuration saved to FTP server successfully as {file_name}.")
