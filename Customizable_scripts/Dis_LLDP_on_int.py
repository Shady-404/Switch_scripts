...
try:
    ...
    # Commands to disable LLDP on the specified interface(s)
    commands = [
        "configure terminal",
    ...
    print(f"LLDP has been disabled on interface(s) {interfaces}!")
    ...
    print(f"Failed to disable LLDP on interface(s) {interfaces}.")
