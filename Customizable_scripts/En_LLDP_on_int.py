...
try:
    ...
    # Commands to enable LLDP on the specified interface(s)
    commands = [
        "configure terminal",
    ...
    print(f"LLDP has been enabled on interface(s) {interfaces}!")
    ...
    print(f"Failed to enable LLDP on interface(s) {interfaces}.")
