...
try:
    ...
    interface = get_user_input("Enter the interface to configure (e.g., 'Ethernet0/1'): ")
    ...
    print("Switch configured as a DHCP client successfully")
    ...
    print("An error occurred while configuring the switch as a DHCP client.")
