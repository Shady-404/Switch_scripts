...
try:
    ...
    # Commands to enable CDP on the specified interface(s)
    commands = [
        "configure terminal",
    ...
    print(f"CDP has been enabled on interface(s) {interfaces}!")
    ...
    print(f"Failed to enable CDP on interface(s) {interfaces}.")
