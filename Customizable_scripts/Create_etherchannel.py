...
try:
    ...
    # Prompt user for the EtherChannel group number, interfaces, and mode
    ...
    # Commands to create EtherChannel
    commands = [
        f"interface range {interfaces}",
        f"channel-group {group_no} mode {mode}"
    ]
    ...
    if '% Invalid input detected' in output:
        ...
        print(f"EtherChannel group {group_no} created with interfaces {interfaces} in mode {mode}")
    ...
    print(f"Failed to create EtherChannel group {group_no}.")
