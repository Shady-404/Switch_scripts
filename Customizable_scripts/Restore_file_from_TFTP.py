...
try:
    ...
    # Command to restore the configuration from TFTP server
    command = f"copy tftp://{tftp_server}/{file_name} running-config"
    ...
    print(f"Configuration restored from TFTP server successfully from {file_name}.")
