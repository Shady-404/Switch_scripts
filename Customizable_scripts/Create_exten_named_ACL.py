...
try:
    ...
    acl_name = get_user_input("Enter the extended ACL name: ")
    ...
    while True:
        ...
        if entry.strip() == '':
            break
        acl_entries.append(f"ip access-list extended {acl_name}")
    ...
    print(f"Extended named ACL '{acl_name}' configured and applied to interface {interface} {direction} successfully")
