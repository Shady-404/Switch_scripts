...
try:
    ...
    # Command to restore the startup configuration from FTP server
    command = f"copy ftp://{ftp_username}:{ftp_password}@{ftp_server}/{file_name} startup-config"
    ...
    print(f"Startup configuration restored from FTP server successfully from {file_name}.")
